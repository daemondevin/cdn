// ===
// CodeMirror-AdvancedDialog plugin
// Originally authored by Jamie Morris
// Modified for use with Codeditor
// ========

  
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: http://codemirror.net/LICENSE
// Originally written by Jamie Morris
// Modified by Devin Gaul
...
(function (mod) {
    ...
    let createPanel = (cm, template, options) => {
    ...
    CodeMirror.defineExtension(
        ...
        function (template, options) {
            ...
            let panel = createPanel(this, template, options);
